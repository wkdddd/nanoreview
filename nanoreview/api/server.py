"""OpenAI-compatible HTTP API server for a fixed nanoreview session.
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = request.app.get("model_name", "nanoreview")
    return web.json_response(
        {
            "object": "list",
            "data": [
...
def create_app(
    agent_loop, model_name: str = "nanoreview", request_timeout: float = 120.0
) -> web.Application:
