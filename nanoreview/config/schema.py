...
class ModelPresetConfig(Base):
    ...
    def to_generation_settings(self) -> Any:
        from nanoreview.providers.base import GenerationSettings
...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.nanoreview/workspace"
    ...
    bot_name: str = "nanoreview"  # Display name shown in CLI prompts (e.g. "{name} is thinking...")
...
class Config(BaseSettings):
    """Root configuration for nanoreview."""
...
def _resolve_tool_config_refs() -> None:
    ...
    like ``from nanoreview.config.schema import ExecToolConfig`` continue to work.
    """
    import sys
