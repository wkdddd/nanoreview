...
from nanoreview.config.paths import get_legacy_sessions_dir
...
from nanoreview.utils.subagent_channel_display import scrub_subagent_announce_body
from nanoreview.utils.subagent_trace import delete_subagent_trace
...
class SessionManager:
    ...
    def _get_legacy_session_path(self, key: str) -> Path:
        """Legacy global session path (~/.nanoreview/sessions/)."""
